...
export function WhatsAppFab() {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.94 }}
      className="fixed bottom-5 z-40 grid size-12 place-items-center rounded-full glass-strong shadow-2xl safe-bottom"
      style={{ insetInlineEnd: "1rem" }}
    >
      <span
        aria-hidden
        className="absolute inset-0 -z-10 rounded-full animate-pulse-soft"
        style={{
          background:
